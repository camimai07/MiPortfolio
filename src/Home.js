                        ...
                        <div className="img-texto">
                            <div className="texto">
                                ...
                                <div className="contacto-icons-home">
                                    ...
                                    <div className="contacto-icons-home_a"><a href="https://drive.google.com/file/d/1pn4UdnWLZizxRjGsavSg8jBCbf3DxBPV/view?usp=sharing" target="_blank"><i className="fa-solid fa-sheet-plastic" style={{color: '#fffbfe'}}></i></a></div>
