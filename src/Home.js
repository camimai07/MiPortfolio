                        ...
                        <div className="img-texto">
                            <div className="texto">
                                ...
                                <div className="contacto-icons-home">
                                    ...
                                    <div className="contacto-icons-home_a"><a href="https://drive.google.com/file/d/1d4JZYeINKhC1Nq8UlM_VXccuAegjSDbz/view?usp=sharing" target="_blank"><i className="fa-solid fa-sheet-plastic" style={{color: '#fffbfe'}}></i></a></div>
