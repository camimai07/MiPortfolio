                        ...
                        <div className="img-texto">
                            <div className="texto">
                                ...
                                <div className="contacto-icons-home">
                                    ...
                                    <div className="contacto-icons-home_a"><a href="https://drive.google.com/file/d/1NwrLMX1pw3dSkutuJrzjgT5DJsOxW4kh/view?usp=sharing" target="_blank"><i className="fa-solid fa-sheet-plastic" style={{color: '#fffbfe'}}></i></a></div>
