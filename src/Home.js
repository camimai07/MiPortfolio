          ...
          <div className="img-texto">
            <div className="texto">
              <h1 className="animate__animated animate__lightSpeedInRight">
                Camila Luciana Maita
              </h1>
              <br />
              <h1>
                Full Stack Developer<span className="guion">_</span>
              </h1>
              <br />
              ...
              <div className="contacto-icons-home">
                <div className="contacto-icons-home_a">
                  <a
                    href="https://wa.me/+5491169971238"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <i
                ...
                <div className="contacto-icons-home_a">
                  <a href="mailto:camilamaita07@gmail.com" target="_blank">
                    <i
                ...
                <div className="contacto-icons-home_a">
                  <a
                    href="https://drive.google.com/file/d/1deL5cWHjYUsaQc6gVG5u6ZUwWkR9hF2d/view?usp=sharing"
                    target="_blank"
                  >
                    <i
